        ...
        <footer className="py-5 px-5 d-flex flex-column justify-content-center align-items-center">
          <div className="flex-column align-content-center">
            <div className="align-items-center justify-content-center">
              <h5 className="ftr-contacto ">
                <Link
                  to={"/faqs"}
                  className="nav-link text-center d-flex justify-content-center ftr-contacto"
                >
            ...
            <div className="align-items-center d-flex justify-content-center flex-column ftr">
              <h5 className="nav-link text-center d-flex text-white justify-content-center">
                MEDIOS DE PAGO
              </h5>
              <ul className="nav align-items-center justify-content-between ftr">
                <li className="nav-item mx-3 my-2 d-flex justify-content-center">
                  <img
                    alt=""
                    className="mediosDePago"
                    src="assets/images/pay_method/tarjeta.svg"
                  />
                </li>
                <li className="nav-item mx-3 my-2 d-flex justify-content-center">
                  <img
                    alt=""
                    className="mediosDePago"
                    src="assets/images/pay_method/MePa.svg"
                  />
                </li>
                <li className="nav-item mx-3 my-2 d-flex justify-content-center">
                  <img
                    alt=""
                    className="mediosDePago"
                    src="assets/images/pay_method/efectivo.svg"
                  />
                </li>
              </ul>
            </div>
          ...
          <div className="d-flex justify-content-center pt-4 mt-4 border-top flex-column ftr">
            <div className="align-items-center justify-content-center flex-column ftr">
              <h5 className=" d-flex text-center text-white justify-content-center">
                ¡ESTAMOS EN CONTACTO!
              </h5>
              <ul className="justify-content-center d-flex align-content-center me-5 ftr">
                <li className="m-4 align-items-center d-flex text-white column justify-content-center redes">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="px-1 flex-column text-white text-decoration-none d-flex flex-wrap"
                  >
                ...
                <li className="m-4 align-items-center d-flex text-white column justify-content-center redes">
                  <a
                    ...
                    rel="noreferrer"
                    target="_blank"
                    className="px-1 flex-column text-white text-decoration-none align-content-center d-flex flex-wrap"
                  >
                    <div className="d-flex justify-content-center m-2">
                ...
                <li className="m-4 align-items-center d-flex text-white column justify-content-center redes">
                  <a
                    href="mailto:blooma.beautystudio@gmail.com"
                    target="_blank"
                    rel="noreferrer"
                    className="px-4 flex-column text-white text-decoration-none d-flex flex-wrap"
                  >
                    <div className="d-flex justify-content-center m-2">
                      <TfiEmail size="2.2em" />
                    </div>
