  ...
  return (
    <div>
      <div className="d-flex justify-content-center align-content-center p-5 ms-5 flex-column">
        ...
        <span className="fw-bold text-decoration-underline titulo">
          contacto!
        </span>
      </div>
          ...
          <div className="mx-5 d-flex flex-column">
            <div className=" d-flex justify-content-center align-content-center flex-column  pb-2 mt-5">
              ...
              <div className="justify-content-start d-flex align-content-center flex-column mb-3">
                <p className="justify-content-start d-flex align-content-center mb-0">
                  Nos podes encontrar en
                </p>
                <p className="justify-content-start d-flex align-content-center">
                  Islandia 26 entre Avenida General Hornos y Darwin.
                </p>
              </div>
              <div className="justify-content-start d-flex align-content-center flex-column mb-3">
                <p className="justify-content-start d-flex align-content-center mb-0">
            ...
            <div className="justify-content-center d-flex align-content-center mb-5">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3279.739525585919!2d-58.429784199999986!3d-34.711749199999986!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x95bccdb2bbd55675%3A0x59a14e48dea5c468!2sCAB%2C%20Islandia%2026%2C%20B1821%20Villa%20Fiorito%2C%20Provincia%20de%20Buenos%20Aires!5e0!3m2!1ses-419!2sar!4v1675391302495!5m2!1ses-419!2sar"
                width="950"
                height="450"
                allowfullscreen=""
                loading="lazy"
